...
{
  new (message_memory) message_interface::msg::Mode(_init);
}

void Mode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_interface::msg::Mode *>(message_memory);
  typed_message->~Mode();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_message_member_array[1] = {
  {
    ...
    offsetof(message_interface::msg::Mode, modenum),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Mode_message_members = {
  ...
  "Mode",  // message name
  1,  // number of fields
  sizeof(message_interface::msg::Mode),
...
{
  return &::message_interface::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_interface, msg, Mode)() {
  return &::message_interface::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
