...
class FakeDriver(Node):
    ...
    def publish_callback(self):
        global angle
        global linear
        linear_scale = (1.0 / (0.254 * pi))
        angle_scale = (455.0 / (508.0 * pi))
        ...
        self.joint_states.position[0] += linear * linear_scale - angle * angle_scale
        self.joint_states.position[1] += linear * linear_scale + angle * angle_scale
#        self.joint_states.position[0] = 0.0
#        self.joint_states.position[1] = 0.0
