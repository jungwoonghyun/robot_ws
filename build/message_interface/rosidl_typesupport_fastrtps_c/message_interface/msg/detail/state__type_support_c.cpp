...
#include "message_interface/msg/detail/state__rosidl_typesupport_fastrtps_c.h"
...
using _State__ros_msg_type = message_interface__msg__State;
...
size_t get_serialized_size_message_interface__msg__State(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name statenum
  {
    size_t item_size = sizeof(ros_message->statenum);
...
static uint32_t _State__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_interface__msg__State(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_interface
size_t max_serialized_size_message_interface__msg__State(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface__msg__State;
    is_plain =
      (
      offsetof(DataType, statenum) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _State__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_message_interface__msg__State(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_interface, msg, State)() {
