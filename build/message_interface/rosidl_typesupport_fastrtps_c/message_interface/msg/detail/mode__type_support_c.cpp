...
#include "message_interface/msg/detail/mode__rosidl_typesupport_fastrtps_c.h"
...
using _Mode__ros_msg_type = message_interface__msg__Mode;
...
size_t get_serialized_size_message_interface__msg__Mode(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name modenum
  {
    size_t item_size = sizeof(ros_message->modenum);
...
static uint32_t _Mode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_interface__msg__Mode(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_interface
size_t max_serialized_size_message_interface__msg__Mode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface__msg__Mode;
    is_plain =
      (
      offsetof(DataType, modenum) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Mode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_message_interface__msg__Mode(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_interface, msg, Mode)() {
