...
static const _Mode_type_support_symbol_names_t _Mode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_interface, msg, Mode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_interface, msg, Mode)),
  }
};
...
get_message_type_support_handle<message_interface::msg::Mode>()
{
  return &::message_interface::msg::rosidl_typesupport_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, message_interface, msg, Mode)() {
  return get_message_type_support_handle<message_interface::msg::Mode>();
}
