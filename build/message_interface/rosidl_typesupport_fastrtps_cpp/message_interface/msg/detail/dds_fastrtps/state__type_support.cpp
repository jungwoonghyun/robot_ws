...
#include "message_interface/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const message_interface::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  message_interface::msg::State & ros_message)
{
  // Member: statenum
  cdr >> ros_message.statenum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const message_interface::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_interface::msg::State *>(
    untyped_ros_message);
...
{
  return &message_interface::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_interface, msg, State)() {
  return &message_interface::msg::typesupport_fastrtps_cpp::_State__handle;
}
