...
#include "message_interface/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const message_interface::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_interface::msg::Mode *>(
    untyped_ros_message);
...
{
  return &message_interface::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
