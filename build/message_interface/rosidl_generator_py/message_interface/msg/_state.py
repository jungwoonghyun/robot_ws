...
class State(metaclass=Metaclass_State):
    ...
    def __init__(self, **kwargs):
        ...
        self.statenum = kwargs.get('statenum', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.statenum != other.statenum:
            return False
        return True
    ...
    def statenum(self, value):
        if __debug__:
            assert \
                ...
                "The 'statenum' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'statenum' field must be an integer in [-2147483648, 2147483647]"
