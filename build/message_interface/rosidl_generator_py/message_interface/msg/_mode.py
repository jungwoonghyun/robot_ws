...
class Mode(metaclass=Metaclass_Mode):
    ...
    def __init__(self, **kwargs):
        ...
        self.modenum = kwargs.get('modenum', int())
    ...
    @builtins.property
    def modenum(self):
        """Message field 'modenum'."""
        return self._modenum

    @modenum.setter
    def modenum(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'modenum' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'modenum' field must be an integer in [-2147483648, 2147483647]"
        self._modenum = value
